...
function AdminDashboard() {
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Dashboard do Tenant</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Resumo Recente</h2>
        <p className="text-gray-600">Aqui você pode ver um resumo das atividades recentes do seu tenant.</p>
      </div>
    </div>
  );
}